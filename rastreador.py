...
# Copy the consumer key (API key),
#consumer secret, access token and
# access token secret
CONSUMER_KEY = 'ya0bTACVPjuc6Y2NjptbDbnxR'
CONSUMER_SECRET = 'rJQh9lE3daKdAqQEvLra1KZzmuvGSaOZp9kV3fwgZ3q7cIasQQ'
ACCESS_TOKEN = '1855823004-mtZkdGQgEaLgMrzw97Vs3h14nh9xeRQNQv4YNTj'
ACCESS_TOKEN_SECRET = 'H2HPvAkLJ7uHsUsCCQjoowcKIlKD27ByQrpkKMpWeXXso'
